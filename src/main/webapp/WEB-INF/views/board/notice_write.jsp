...
<div class="container-lg mt-5   ">
	...
	<div class="board_w">
		<div class="form-group  mt-3">
			...
			<input type="text" class="form-control" name="text_title" id="text_title" placeholder="제목을 입력하세요" required/>
		  </div>

		  <div class="form-group  mt-3">
		  
			
    <textarea class="form-control" id="text_content" name="text_content" rows="10"  placeholder="내용을 입력하세요" ></textarea>
		  </div>
