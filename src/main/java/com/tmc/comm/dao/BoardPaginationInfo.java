...
@Data
public class BoardPaginationInfo {
	...
	public BoardPaginationInfo(BoardCriteria criteria) {
	...
	public BoardCriteria getCriteria() {
		return criteria;
	}

	public void setCriteria(BoardCriteria criteria) {
		this.criteria = criteria;
	}
